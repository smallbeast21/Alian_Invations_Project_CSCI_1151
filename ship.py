"""
Module: defines the player's spaceship and its movement.

Assets:
- Uses YellowShip.png (player sprite, see settings.py)
"""
...
class Ship:
    ...
    def pick_side(self) -> None:
        """
        Switch ship to the opposite side (currently only to left).
        """
        self.side = 'left'
        self._set_orientation_and_position()
